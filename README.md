...
질의회신이 인용한 기준서 문단을 정답으로 삼아, 검색이 그 근거를 회수하는지 측정했습니다. recall을 **세 단위로 병기**해 정직하게 보여줍니다.
...
- 문단 exact는 정답 바로 옆 문단조차 오답으로 처리하는 매우 엄격한 지표라, **호 recall(0.808)이 실질 유용성에 더 가깝습니다.** 세 지표를 모두 공개하는 이유입니다.
