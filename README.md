...
- **구어체 질문 검색 실패 — rewrite 정규화 추가**: "개발비의 자산인식요건 알려줘"처럼 붙여쓰거나 구어체인 질문은 정답 문단의 리랭커 점수가 0.608에서 0.012로 급락해 검색에서 통째로 탈락했습니다. 매 질의를 검색 친화적으로 다시 쓰는 rewrite 단계를 추가해 점수를 0.576까지 회복시켰습니다.
